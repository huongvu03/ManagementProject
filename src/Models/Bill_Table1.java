...
public class Bill_Table1 {
    ...
    public Bill_Table1(String proId, String proName, int cateId, int quantity, double proPrice, String status, String proImage, Double billTotal, Double billTax, Double billService, Double billDiscount, Double billSubTotal, String cus_id, String cus_name) {
        this.proId = proId;
